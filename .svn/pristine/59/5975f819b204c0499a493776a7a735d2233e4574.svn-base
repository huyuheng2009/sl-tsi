...
public class StringUtils {
	...
	public static boolean isEmptyWithTrim(String str){
		if(str==null || str.trim()==""||str.trim().length()<=0) return true;
		return false;
	}
	
	public static boolean isNotEmptyWithTrim(String str){
		if(str==null || str.trim()==""||str.trim().length()<=0) return false;
		return true;
	}
	...
	public static void main(String [] args) {
		//System.out.println(getRandomString(6, false));
		//System.out.println(UUID.randomUUID().toString().replace("-", ""));
		
		
		 String path = "/head/image/101001010110/jfskajfslkaf.jpg" ;
