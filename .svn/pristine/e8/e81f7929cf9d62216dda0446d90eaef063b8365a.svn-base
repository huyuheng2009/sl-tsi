...
public class AmapUtil {
	...
	private static String APIURL = "http://restapi.amap.com/v3/geocode/geo?key=e06d4341a635e738a7c856bb38b37812&s=rsv3&address=";

	public static Map<String, String> addressToGPS(String address) throws Exception {
		System.out.println("请求高德，获取地址坐标");
		String requestUrl = APIURL + URLEncoder.encode(address, "UTF-8");
		String resultJson = "";
		try {
			resultJson=	readContentFromGet(requestUrl);
		} catch (Exception e) {
			e.printStackTrace();
		}
